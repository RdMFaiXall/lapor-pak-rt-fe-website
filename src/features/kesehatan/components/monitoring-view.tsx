            ...
            <Main>
                <div className='mb-6 flex items-center justify-between space-y-2'>
                    ...
                    <p className='text-muted-foreground'>
                        Pantau statistik kesehatan dan isu medis di lingkungan RT.
                    </p>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-3">
                    ...
                    <Card className="lg:col-span-2 shadow-md flex flex-col">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Urutan permasalahan kesehatan dari yang paling sering dilaporkan.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card className="lg:col-span-1 shadow-md flex flex-col">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Perbandingan persentase tiap jenis isu kesehatan.
                            </CardDescription>
                        </CardHeader>
