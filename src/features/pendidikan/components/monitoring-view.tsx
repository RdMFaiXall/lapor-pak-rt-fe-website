    ...
    const chartData = Object.values(
        ...
        .map((item, index) => {
            ...
            return {
                ...
                label: `${item.jumlah}` // Simplified label
            }
        })
        ...
        <>
            ...
            <Main>
                <div className='mb-6 flex items-center justify-between space-y-2'>
                    <h1 className='text-2xl font-bold tracking-tight'>Monitoring Pendidikan</h1>
                    <p className='text-muted-foreground'>
                        Pantau statistik pendidikan dan isu sekolah di lingkungan RT.
                    </p>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-3">
                    ...
                    <Card className="lg:col-span-2 shadow-md flex flex-col">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Urutan permasalahan pendidikan dari yang paling sering dilaporkan.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card className="lg:col-span-1 shadow-md flex flex-col">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Perbandingan persentase tiap jenis isu pendidikan.
                            </CardDescription>
                        </CardHeader>
